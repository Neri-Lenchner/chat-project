...
import {presenceSocketService} from "./services/presence-socket-service";
import {typingSocketService} from "./services/typing-socket-service";
import {readSocketService} from "./services/read-socket-service";
...
presenceSocketService.listenForPresenceChanges();
typingSocketService.listenForTyping();
readSocketService.listenForReadReceipts();
